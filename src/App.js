...
*/
  ...
  render() {
    const {
      ...
      school, degree, eduDateFrom, eduDateTo, eduEditMode, // eslint-disable-next-line 
      eduNr, educations,
      company, workTitle, tasks, workDateFrom, workDateTo, workEditMode, // eslint-disable-next-line 
      workNr, experiences
    } = this.state;
